...
(c) TNEL, umn
%}
function [dat1] = cm_ts_main_stimulation_site_15(letrun)
    ...
    for dst = ["noalgorithm","greedy","egreedy","UCB","UCBbay","bernoulli","Poisson","Normal","bothNormal"]
        ...
        for test = 1
            ...
            for divisor = 15
                ...
                for model = [2,4,6,8]
                    clearvars -except  letrun NTrials snr dat1 dst model data1 seqcon conv3 cnt2 correctAns SDMall RDU divisor cnt prb test seq prb2
                    vL.techni = 1;
                ...
                save(strcat('D:\Sumedh\Projects\Methods for psychiatric DBS programming\DataA\Stimulation site\Stim site with gen uniformity\15 BS\StimSites_',dst,num2str(letrun),'fdelBS.mat'),'dat1','-v7.3');
                dat1 = [];
                data1 = [];
            end
        end
