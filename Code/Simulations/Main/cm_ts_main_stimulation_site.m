...
(c) TNEL, umn
%}
function [dat1] = cm_ts_main_stimulation_site(letrun)
    ...
    for dst = ["noalgorithm","greedy","egreedy","UCB","UCBbay","bernoulli","Poisson","Normal","bothNormal"]
        ...
        for test = 1
            ...
            for divisor = 10
                ...
                save(strcat('D:\Sumedh\Projects\Methods for psychiatric DBS programming\DataA\Stimulation site\Stim site with gen uniformity\10 BS\StimSites_',dst,num2str(letrun),'10BS.mat'),'dat1','-v7.3');
                dat1 = [];
                data1 = [];
            end
        end
