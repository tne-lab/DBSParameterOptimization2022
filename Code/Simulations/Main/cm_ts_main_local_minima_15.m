...
(c) TNEL, umn
%}
function [dat1] = cm_ts_main_local_minima_15()
...
for NTrials = 600
    ...
    for dst = ["greedy","egreedy","UCBbay","bernoulli","Poisson","Normal","bothNormal"]
        ...
        for test = 1:7
            ...
            for divisor = 15
                ...
                dat1.(strcat("dist_",dst,num2str(divisor))).data = data1;
              	...
              	save(strcat('D:\Sumedh\Projects\Methods for psychiatric DBS programming\DataA\Local minima\local minima with gen uniformity\Local_',dst,'153BS.mat'),'dat1','-v7.3');
                dat1 = [];
                data1 = [];
    end
end
